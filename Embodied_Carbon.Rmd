...
```{r}
Construction <- read_csv("construction_costs.csv") 

```

##Estimate Embodied Emissions of buildings and construction 

Bring in building stock information from first Markdown and add in construction intensity data

```{r}
BS_2050 <- read.csv("BS_2050.csv")
...
Add building intensity data to this dataset 
...
```{r}
Embodied_Carbon <- read_csv("Embodied_Carbon.csv")

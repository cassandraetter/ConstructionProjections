...
BS_2050 <- merged_2050_2 %>%
        ...
        mutate(avg_m2_house = gdp_per_capita / 1000) %>%
        mutate(residential_building_stock_m2 = num_households * avg_m2_house) %>%

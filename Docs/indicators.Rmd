...
```{r}
undesa_pd_2022_hh_size_composition <- read_excel("undesa_pd_2022_hh-size-composition.xlsx", 
...
```{r}
ssp_scenarios <- read_excel("2023-11-19 - IIASA SSP scenarios.xlsx") %>% as.data.table %>%

...
```{r}
undesa_pd_2022_hh_size_composition <- read_excel("Data/undesa_pd_2022_hh-size-composition.xlsx", 
...
```{r}
ssp_scenarios <- read_excel("Data/2023-11-19 - IIASA SSP scenarios.xlsx") %>% as.data.table %>%
...
##calculate floor space estimate using projections data 

```{r}
BS_2050 <- merged_2050_2 %>%
        mutate(average_household_size = as.numeric(`Average household size (number of members)`)) %>%
        ...
        mutate(total_building_stock_m2 = residential_building_stock_m2 * 2 )
...
```{r}
Deetman_SQM_Projections <- read_excel("Data/Deetman_SQM_Projections.xlsx", 
...
```
Our Estimates: Canada 2030= 4033394549 and 2050 = 5016870370
Our Estimates: Japan 2030 =  10792050499 and 2050 = 11131133830
Our Estimates: India  2030 = 30230094337 and 2050 = 63935008264
Our Estimates: United States 2030 = 48898569289 and 2050 = 63147062557
